...
## Hvorfor er regresjonsanalyse så anvendt?
...
Kjører en enkel lineær regresjonsanalyse $\hat{Y} = \hat\alpha + \hat\beta x$
...
Kjører en multippel lineær regresjonsanalyse: $Y_i = \alpha + \beta_1 x_1, _i + \beta_2 x_2, _i + . . . + \beta_{k} x_k, _i + \epsilon_i$
...
::: {.column width="50%"}
::: incremental
-   I (Quantile-Quantile) QQ-plottet sammenligner man fordelingen av residualene med en normal fordeling.
-   Her ser vi fordelingen til "error termen" og ser at fordelingen er tilnærmet normalfordelt, for da hadde den fulgt den røde linjen perfekt. Men det vi kan se er at resultatet er ganske "nært" den røde linjen.
...
::: {.column width="50%"}
::: incremental
-   Her ser vi også at det ikke "bryter" med normalfordelingen
-   Og at forholdene tilnærmet er normalfordelt utenom noen små "outlier" i begge ender av halen til normalfordelingen.
-   Det finnes mye mer å kunne gjøre og teste men det er kun så mye man rekker
-   I denne visuelle undersøkelsen av homoskedastisitet bryter ikke antakelsen, og jeg vil si at
:::
:::
:::
