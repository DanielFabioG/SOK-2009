...
Nei, den er ikke lik siden vi har betinget sannsynlighet.
...
utfall %>%
  ...
  geom_point(size=3) +
  geom_abline()+
  scale_color_manual(values = c("limegreen", "palevioletred"),
                     labels = c("Mulige utfall", "Ikke mulige utfall")) +
...
Nuke det her og add det man faktisk skal ha
